...
class GMM(object):
    ...
    def cuda_backend_render_func(param_dict, vals):
        cu_kern_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_cuda_kernels.mako", disable_unicode=True)
        cu_kern_rend = cu_kern_tpl.render( param_val_list = vals, **param_dict)
        GMM.asp_mod.add_to_module([Line(cu_kern_rend)],'cuda')
        c_decl_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_cuda_launch_decl.mako", disable_unicode=True) 
    ...
    def cilk_backend_render_func(param_dict, vals):
        cilk_kern_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_cilk_kernels.mako", disable_unicode=True)
        cilk_kern_rend = cilk_kern_tpl.render( param_val_list = vals, **param_dict)
        GMM.asp_mod.add_to_module([Line(cilk_kern_rend)],'cilk')
        c_decl_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_cilk_kernel_decl.mako", disable_unicode=True) 
        c_decl_rend  = c_decl_tpl.render( param_val_list = vals, **param_dict)
...
#                self.get_asp_mod().alloc_evals_on_CPU(self.eval_data.memberships, self.eval_data.loglikelihoods)
    ...
    def insert_base_code_into_listed_modules(self, names_of_modules):
        c_base_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_base_helper_funcs.mako", disable_unicode=True)
        ...
        names_of_helper_funcs = ["alloc_events_on_CPU", "alloc_components_on_CPU", "alloc_evals_on_CPU", "alloc_index_list_on_CPU", "alloc_events_from_index_on_CPU", "dealloc_events_on_CPU", "dealloc_index_list_on_CPU", "dealloc_components_on_CPU", "dealloc_temp_components_on_CPU", "dealloc_evals_on_CPU", "get_temp_component_pi", "get_temp_component_means", "get_temp_component_covars", "relink_components_on_CPU", "compute_distance_rissanen", "merge_components", "compute_KL_distance", "create_lut_log_table" ]
        base_system_header_names = [ 'stdlib.h', 'stdio.h', 'string.h', 'math.h', 'time.h','pyublas/numpy.hpp']
    ...
    def insert_non_rendered_code_into_cuda_module(self):
        ...
        c_base_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_cuda_host_helper_funcs.mako", disable_unicode=True)
        c_base_rend  = c_base_tpl.render()
        GMM.asp_mod.add_to_module([Line(c_base_rend)],'cuda_boost')
        cu_base_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_cuda_device_helper_funcs.mako", disable_unicode=True)
    ...
    def insert_non_rendered_code_into_cilk_module(self):
        ...
        cilk_base_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_cilk_helper_funcs.mako", disable_unicode=True)
    ...
    def render_and_add_to_module( self, param_dict, limit_generator, render_backend_specific_funcs, backend_name):
        ...
        c_train_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_"+backend_filename+"_train.mako", disable_unicode=True)
        c_eval_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_"+backend_filename+"_eval.mako", disable_unicode=True)
        c_seed_tpl = AspTemplate.Template(filename="/home/hadoop/opt/hcook/templates/em_"+backend_filename+"_seed.mako", disable_unicode=True)
