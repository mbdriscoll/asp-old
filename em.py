...
class GMM(object):
    ...
    def initialize_asp_mod(self):
        ...
        GMM.asp_mod.add_to_init("""boost::python::class_<return_array_container>("ReturnArrayContainer")
    ...
    def train(self, input_data):
        ...
        self.get_asp_mod().train( 0, self.M, D, N, input_data)
        means = self.get_asp_mod().compiled_module.trained.means.reshape((self.M, D))
        covars = self.get_asp_mod().compiled_module.trained.covars.reshape((self.M, D, D))
